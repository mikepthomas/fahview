package info.mikethomas.fahview.v6project.panels;
...
import info.mikethomas.fahview.v6project.model.QueueImpl;
import info.mikethomas.fahview.v6project.utilities.ProgressCellRenderer;
 ...
 */
@ConvertAsProperties(
    dtd="-//info.mikethomas.fahview.v6project.panels//Queue//EN",
    autostore=false
)
@TopComponent.Description(
    preferredID="QueueTopComponent",
    iconBase="info/mikethomas/fahview/v6project/queue.png",
    persistenceType=TopComponent.PERSISTENCE_ALWAYS
)
@TopComponent.Registration(mode = "editor", openAtStartup = false)
@ActionID(category = "Window", id = "info.mikethomas.fahview.v6project.panels.QueueTopComponent")
