package info.mikethomas.fahview.v6project.properties;
...
import info.mikethomas.fahview.v6project.ClientProject;
...
public class ClientCustomizerProvider implements CustomizerProvider {
    ...
    /** Constant <code>CUSTOMIZER_FOLDER_PATH="Projects/info-mikethomas-fahview/Customi"{trunked}</code> */
    public static final String CUSTOMIZER_FOLDER_PATH =
            "Projects/info-mikethomas-fahview/Customizer";
     ...
     *
     * @param project a {@link info.mikethomas.fahview.v6project.ClientProject} object.
     */
