...
import info.mikethomas.fahview.v6project.properties.ClientCustomizerProvider;
...
public class ClientProject implements Project {
    ...
    public static final String PROJECT_ICON =
            "info/mikethomas/fahview/v6project/client.png";
        ...
        private static class ProjectNode extends FilterNode {
            ...
            public ProjectNode(final Node node,
                ...
                super(node,
                        ...
                        clientProject,
                        "Projects/info-mikethomas-fahview-client/Nodes"),
                        new ProxyLookup(
                        new Lookup[]{
