package info.mikethomas.fahview.v6project.nodes;
...
import info.mikethomas.fahview.v6project.ClientSubprojectProvider;
import info.mikethomas.fahview.v6project.WorkProject;
 ...
 * @version $Id: $Id
 */
@NodeFactory.Registration(projectType = "info-mikethomas-fahview-client", position = 10)
        ...
        public Node node(Project key) {
            ...
            try {
                fn = new FilterNode(DataObject.find(key.
                        ...
                        key, "Projects/info-mikethomas-fahview-work/Nodes")){
                    @Override
