package info.mikethomas.fahview.v6project.model;
...
import info.mikethomas.fahview.v6project.utilities.QueueReader;
...
public class QueueImplTest extends TestCase {
    ...
    private QueueReader testFile = new QueueReader("src/test/java/info/mikethomas/fahview/v6project/queue.dat");
