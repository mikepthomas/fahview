 ...
 * @version 6.00
 */
public class WorkUnit implements WorkUnitInterface {
     ...
     */
    public WorkUnit(int indexNumber, QueueReader reader) throws InstantiationException {
        percentage = "0%";
        this.indexNumber = indexNumber;
        switch (indexNumber) {
            case 0:
                position = Queue.QUEUE_INDEX_0_POS + QueueIndex.WUID_POS;
                break;
            case 1:
                position = Queue.QUEUE_INDEX_1_POS + QueueIndex.WUID_POS;
                break;
            case 2:
                position = Queue.QUEUE_INDEX_2_POS + QueueIndex.WUID_POS;
                break;
            case 3:
                position = Queue.QUEUE_INDEX_3_POS + QueueIndex.WUID_POS;
                break;
            case 4:
                position = Queue.QUEUE_INDEX_4_POS + QueueIndex.WUID_POS;
                break;
            case 5:
                position = Queue.QUEUE_INDEX_5_POS + QueueIndex.WUID_POS;
                break;
            case 6:
                position = Queue.QUEUE_INDEX_6_POS + QueueIndex.WUID_POS;
                break;
            case 7:
                position = Queue.QUEUE_INDEX_7_POS + QueueIndex.WUID_POS;
                break;
            case 8:
                position = Queue.QUEUE_INDEX_8_POS + QueueIndex.WUID_POS;
                break;
            case 9:
                position = Queue.QUEUE_INDEX_9_POS + QueueIndex.WUID_POS;
                break;
            default:
    ...
    /**
     * Generate a String representation of the WorkUnit
     * 
     * @return String
     */
    @Override
