...
public interface QueueIndexInterface {
     ...
     */
    public static final int Z004_POS = 4;
    /**
     * Position in bytes of Time data from the start of {@code queue.dat}
     */
    public static final int TDATA_POS = 8;
    /**
     ...
     * @since 5.00
     */
    public static final int CSIP_POS = 520;
    /**
     ...
     * @since 5.00
     */
    public static final int DSTART_POS = 524;
    /**
     * Position in bytes of padding from the start of {@code queue.dat}
     * (All Zeros)
     */
    public static final int Z528_POS = 528;
    /**
     * Position in bytes of Misc4a from the start of {@code queue.dat}
     */
    public static final int M532_POS = 532;
    /**
     * Position in bytes of padding from the start of {@code queue.dat}
     * (All Zeros)
     */
    public static final int Z536_POS = 536;
    /**
     ...
     * @since 5.91
     */
    public static final int CORES_POS = 544;
    /**
     * Position in bytes of Tag of Work Unit from the start of {@code queue.dat}
     * 
     * @since 5.00
     */
    public static final int TAG_POS = 548;
    /**
     * Position in bytes of padding from the start of {@code queue.dat}
     * (All Zeros)
     */
    public static final int Z564_POS = 564;
    /**
     * Position in bytes of Passkey from the start of {@code queue.dat}
     * 
     * @since 6.00
     */
    public static final int PASSKEY_POS = 580;
    /**
     ...
     * @since 6.00
     */
    public static final int FLOPS_POS = 612;
    /**
     * Position in bytes of Available memory from the start of {@code queue.dat}
     * 
     * @since 6.00
     */
    public static final int MEMORY_POS = 616;
    /**
     ...
     * @since 6.20
     */
    public static final int GPU_MEMORY_POS = 620;
    /**
     * Position in bytes of padding from the start of {@code queue.dat}
     * (All Zeros)
     */
    public static final int Z624_POS = 624;
    /**
     * Position in bytes of WU expiration time from the start of
     * {@code queue.dat}
     */
    public static final int DUE_POS = 688;
    /**
     ...
     * @since 5.00
     */
    public static final int PLIMIT_POS = 704;
    /**
     ...
     * @since 5.00
     */
    public static final int UPLOADS_POS = 708;
    // </editor-fold>
     ...
     * @see #STAT_POS 
     */
    public static final int STAT_LENGTH = 4;
    /**
     ...
     * @deprecated Use {@link #CORES_POS}
     */
    public static final int Z004_LENGTH = 4;
    /**
     ...
     * @see #TDATA_POS 
     */
    public static final int TDATA_LENGTH = 32;
    /**
     * Length in bytes of the Server IP address in {@code queue.dat}
     * 
     * @deprecated As of 3.00 replaced by {@link #SVR2_POS}
     */
    public static final int SVR1_LENGTH = 4;
    /**
     ...
     * @see #USTAT_POS 
     */
    public static final int USTAT_LENGTH = 4;
    /**
     * Length in bytes of the Web address for core downloads in {@code queue.dat}
     * 
     * @see #getUrl() 
     * @see #URL_POS 
     */
     ...
     * @see #M176_POS 
     */
    public static final int M176_LENGTH = 4;
    /**
     ...
     * @see #CORE_POS 
     */
    public static final int CORE_LENGTH = 4;
    /**
     * Length in bytes of the Misc1b in {@code queue.dat}
     * 
     * @see #M184_POS 
     */
    public static final int M184_LENGTH = 4;
    /**
     ...
     * @see #DSIZ_POS 
     */
    public static final int DSIZ_LENGTH = 4;
    /**
     * Length in bytes of the z192 in {@code queue.dat}
     * 
     * @see #Z192_POS 
     */
    public static final int Z192_LENGTH = 16;
    /**
     ...
     * @see #WUID_POS 
     */
    public static final int WUID_LENGTH = 16;
    /**
     * Length in bytes of the z224 in {@code queue.dat}
     * 
     * @see #Z224_POS 
     */
    public static final int Z224_LENGTH = 36;
    /**
     ...
     * @see #SVR2_POS 
     */
    public static final int SVR2_LENGTH = 4;
    /**
     ...
     * @see #UNAME_POS 
     */
    public static final int UNAME_LENGTH = 64;
    /**
     ...
     * @see #TEAMN_POS 
     */
    public static final int TEAMN_LENGTH = 64;
    /**
     ...
     * @see #BENCH_POS 
     */
    public static final int BENCH_LENGTH = 4;
    /**
     * Length in bytes of Misc3b in {@code queue.dat}
     * 
     * @deprecated 3.24
     */
    public static final int M476_LENGTH = 4;
    /**
     ...
     * @see #CPU_TYPE_POS 
     */
    public static final int CPU_TYPE_LENGTH = 4;
    /**
     ...
     * @see #OS_TYPE_POS 
     */
    public static final int OS_TYPE_LENGTH = 4;
    /**
     ...
     * @see #CPU_SPEC_POS 
     */
    public static final int CPU_SPEC_LENGTH = 4;
    /**
     ...
     * @see #OS_SPEC_POS 
     */
    public static final int OS_SPEC_LENGTH = 4;
    /**
     ...
     * @see #EXPIRE_POS 
     */
    public static final int EXPIRE_LENGTH = 4;
    /**
     * Length in bytes of the z500 in {@code queue.dat}
     * 
     * @see #Z500_POS 
     */
    public static final int Z500_LENGTH = 4;
    /**
     ...
     * @see #CLTYPE_POS 
     */
    public static final int CLTYPE_LENGTH = 4;
    /**
     ...
     * @see #AIFLAG_POS 
     */
    public static final int AIFLAG_LENGTH = 4;
    /**
     ...
     * @see #AITIME_POS 
     */
    public static final int AITIME_LENGTH = 4;
    /**
     ...
     * @see #AIDATA_POS 
     */
    public static final int AIDATA_LENGTH = 4;
    /**
     ...
     * @see #CSIP_POS 
     */
    public static final int CSIP_LENGTH = 4;
    /**
     ...
     * @see #DSTART_POS 
     */
    public static final int DSTART_LENGTH = 4;
    /**
     * Length in bytes of the z528 in {@code queue.dat}
     * 
     * @see #Z528_POS 
     */
    public static final int Z528_LENGTH = 4;
    /**
     * Length in bytes of the Misc4a in {@code queue.dat}
     * 
     * @see #M532_POS 
     */
    public static final int M532_LENGTH = 4;
    /**
     * Length in bytes of the z536 in {@code queue.dat}
     * 
     * @see #Z536_POS 
     */
    public static final int Z536_LENGTH = 8;
    /**
     ...
     * @see #CORES_POS 
     */
    public static final int CORES_LENGTH = 4;
    /**
     ...
     * @see #Z564_POS 
     */
    public static final int Z564_LENGTH = 16;
    /**
     ...
     * @see #PASSKEY_POS 
     */
    public static final int PASSKEY_LENGTH = 32;
    /**
     ...
     * @see #FLOPS_POS 
     */
    public static final int FLOPS_LENGTH = 4;
    /**
     ...
     * @see #MEMORY_POS 
     */
    public static final int MEMORY_LENGTH = 4;
    /**
     ...
     * @see #GPU_MEMORY_POS 
     */
    public static final int GPU_MEMORY_LENGTH = 4;
    /**
     * Length in bytes of the z624 in {@code queue.dat}
     * 
     * @see #Z624_POS
     */
    public static final int Z624_LENGTH = 64;
    /**
     ...
     * @see #DUE_POS 
     */
    public static final int DUE_LENGTH = 16;
    /**
     ...
     * @see #PLIMIT_POS 
     */
    public static final int PLIMIT_LENGTH = 4;
    /**
     ...
     * @see #UPLOADS_POS 
     */
    public static final int UPLOADS_LENGTH = 4;
    // </editor-fold>
