...
public interface WorkUnit {
     ...
     * @see #PROJ_LENGTH 
     */
    public static final int PROJ_POS = 0;
    /**
     ...
     * @see #RUN_LENGTH
     */
    public static final int RUN_POS = 2;
    /**
     ...
     * @see #CLONE_LENGTH
     */
    public static final int CLONE_POS = 4;
    /**
     ...
     * @see #GEN_LENGTH
     */
    public static final int GEN_POS = 6;
    /**
     ...
     * @see #ISSUE_LENGTH
     */
    public static final int ISSUE_POS = 8;
    // </editor-fold>
     ...
     * @see #PROJ_POS 
     */
    public static final int PROJ_LENGTH = 2;
    /**
     ...
     * @see #RUN_POS 
     */
    public static final int RUN_LENGTH = 2;
    /**
     ...
     * @see #CLONE_POS 
     */
    public static final int CLONE_LENGTH = 2;
    /**
     ...
     * @see #GEN_POS 
     */
    public static final int GEN_LENGTH = 2;
    /**
     ...
     * @see #ISSUE_POS 
     */
    public static final int ISSUE_LENGTH = 8;
    // </editor-fold>
