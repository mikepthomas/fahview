...
public class Queue implements QueueInterface {
    ...
    private int version; // Queue (client) version (as of v2.17)
    private int current; // Current index number
    private QueueIndex[] index; // Queue Indices
     ...
     */
    public Queue(QueueReader reader) {
        this.reader = reader;
        update();
    }
    ...
    @Override
    public QueueIndex getQueueIndex(int index) {
    ...
    /**
     * Set the value of Queue (client) version
     */
    ...
    protected void setIndex() {
        try {
            index = new QueueIndex[10];
            index[0] = new QueueIndex(0, reader);
            index[1] = new QueueIndex(1, reader);
            index[2] = new QueueIndex(2, reader);
            index[3] = new QueueIndex(3, reader);
            index[4] = new QueueIndex(4, reader);
            index[5] = new QueueIndex(5, reader);
            index[6] = new QueueIndex(6, reader);
            index[7] = new QueueIndex(7, reader);
            index[8] = new QueueIndex(8, reader);
            index[9] = new QueueIndex(9, reader);
        }
