 ...
 * href="http://fah-web.stanford.edu/daily_team_summary.txt">
 * daily_team_summary.txt</a> into an SQL database.
 *
...
public class Team {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            stmt.executeUpdate("TRUNCATE TABLE daily_team_summary;");


            InputStream in = App.class.getResourceAsStream("/daily_team_summary.txt");
            ...
            while (buf.ready()) {
                ...
                //Execute SQL
                stmt.executeUpdate(
                        "INSERT INTO daily_team_summary "
                        + "(team, teamname, score, wu) "
                        + "VALUES (\"" + team + "\", \"" + teamname + "\", " + score + ", " + wu + ");");
